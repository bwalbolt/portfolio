...
Read AGENTS.md first. Ask only if blocked.

Create `.agents/specs/<feature-slug>.md`:
...
1. Spec saved to `.agents/specs/<slug>.md`
2. Review for completeness — could a new agent implement T1 with no other context?
3. To implement: fresh session → `read .agents/specs/<slug>.md and implement T1`
